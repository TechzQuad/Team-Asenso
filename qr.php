...
<?php 
//coordinator Print
if($data['pos'] == 'Cluster Precint Leader' || $data['pos'] == 'Cluster Precint Leader & Coordinator' || $data['pos'] == 'Cluster Precint Leader & Leader' && $count<3 ){
   ...
   <div class="col-sm-4" style="margin-bottom:20px">
    ...
    //leader print
}else if($data['co'] == 'Coordinator' || $data['lead'] == 'Coordinator'){    
    $sql = "SELECT * FROM election where (pos like '%Leader%') && coordinator_id='".$id[0]."' && pos!='Cluster Precint Leader' order by name";
    $result = $conn->query($sql);
   ...
   <div class="col-sm-4" style="margin-bottom:20px">
    ...
    //Member Print QR
}else if($data['co'] == 'leader' || $data['co'] == 'Leader' || $data['lead'] == 'Cluster Precint Leader & Leader'){
   ...
   //cluster leader Print
    ...
    $sql = "SELECT * FROM election where pos like '%Cluster Precint Leader%' order by name";
    $result = $conn->query($sql);
