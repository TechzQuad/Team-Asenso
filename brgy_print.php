...
<?php 
    ...
    ?>
   <div class="col-sm-4" style="margin-bottom:20.9px">
    <div class="card mb-3 b"  style="max-width:317px;max-height:201.8px; border:2px solid #000000;margin-left:10px;border-radius:5px; text-align:center;">
