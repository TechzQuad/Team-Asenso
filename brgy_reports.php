...
<div class="container mt-3">
  ...
  <a href="print_brgy_reports.php" class="btn btn-secondary pull-right" target="_blank">Print Report >></a><br><br>
...
$sql1 = "SELECT * from election where pos='Cluster Precint Leader' || pos= 'Cluster Precint Leader / Coordinator' order by name";
