 ...
 <table id="voters" class="display" style="width:100%">
    ...
    <tbody>
            <?php
                ...
                $sql = "SELECT election.name,election.standing, election.pn, election.pos, election.brgy, election.prk , attendance.* from attendance INNER JOIN election ON attendance.v_id=election.id order by date ASC";
